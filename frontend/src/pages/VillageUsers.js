  ...
  return (
    <div style={{ background: "#000000", minHeight: "100vh", color: "#ffffff" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 32px" }}>
        ...
        <h1 style={{ fontSize: "clamp(28px, 4vw, 44px)", fontWeight: 700, textTransform: "uppercase", marginBottom: "8px" }}>Watumishi</h1>
        <p style={{ color: "#bbbbbb", fontSize: "14px", fontWeight: 300, marginBottom: "32px" }}>Tazama na simamia watumishi wa kijiji.</p>
